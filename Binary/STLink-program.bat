...
start /b /wait ST-LINK_CLI.exe -c SWD -P OptomosOutput-BTL-20240801-1002.bin 0x8000000 -V "after_programming"
start /b /wait ST-LINK_CLI.exe -c SWD -P OptomosOutput-APP-20240801-2.bin 0x8001000 -V "after_programming"
