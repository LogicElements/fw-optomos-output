  ...
  switch (address)
  {
    ...
    case MB_HOLD_CALIB_RESERVED:
      *value = conf.calib.reserved;
      break;
    case MB_HOLD_OUT_STATE:
      *value = conf.out.state;
      break;
    case MB_HOLD_OUT_DEFAULT_STATE:
      *value = conf.out.default_state;
      break;
    case MB_HOLD_OUT_SET:
      *value = conf.out.set;
      break;
    case MB_HOLD_OUT_CLEAR:
      *value = conf.out.clear;
      break;
...
Status_t MbRtu_WriteHoldingRegCallback(uint16_t address, uint16_t value)
{
  ...
  switch (address)
  {
    ...
    case MB_HOLD_CALIB_RESERVED:
      ...
      break;
    case MB_HOLD_OUT_STATE:
      conf.out.state = value;
      id = CONF_OUT_STATE;
      break;
    case MB_HOLD_OUT_DEFAULT_STATE:
      conf.out.default_state = value;
      id = CONF_OUT_DEFAULT_STATE;
      break;
    case MB_HOLD_OUT_SET:
      conf.out.set = value;
      id = CONF_OUT_SET;
