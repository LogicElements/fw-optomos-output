...
#define CONF_OUT_STATE             0x05000051u  ///< State of all outputs
#define CONF_OUT_DEFAULT_STATE     0x05002071u  ///< Default output state
#define CONF_OUT_SET               0x05004051u  ///< Set output
#define CONF_OUT_CLEAR             0x05006051u  ///< Clear output
...
#define CONF_REG_FLASH_NUMBER      (6)
#define CONF_REG_LOGGER_LENGTH     (0)
#define CONF_REG_CALIB_LENGTH      (8)
#define CONF_REG_SYNCED_LENGTH     (0)
#define CONF_REG_FLASH_LENGTH      (35)
#define CONF_REG_LOCAL_LENGTH      (0)

#define CONF_DIM_CONDITION ((sizeof(conf_reg_sys_t) != 24) || (sizeof(conf_reg_fact_t) != 16) || (sizeof(conf_reg_firm_t) != 16) || (sizeof(conf_reg_com_t) != 12) || (sizeof(conf_reg_calib_t) != 4) || (sizeof(conf_reg_out_t) != 8) || (sizeof(conf_reg_dbg_t) != 4) || 0)
